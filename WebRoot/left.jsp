			...
			<td valign=top align=middle>
				...
				<table id=child0 cellspacing=0 cellpadding=0 width=150 border=0>
					<tr height=20>
						...
						<td><a class=menuchild href="/netbank/deposit.jsp"
							target=main>存款</a>
						</td>
					</tr>
					<tr height=20>
						...
						<td><a class=menuchild href="/netbank/withdrawal.jsp"
							target=main>取款</a>
						</td>
					</tr>
					<tr height=20>
						...
						<td><a class=menuchild href="/netbank/transfer.jsp"
							target=main>转账</a>
						</td>
					</tr>
					<tr height=20>
						...
						<td><a class=menuchild
							href="/netbank/transaction/list?pager.curpage=1" target=main>查询交易记录</a>
						</td>
					</tr>
					<tr height=20>
						<td align=middle width=30><img height=9
						...
						<td><a class=menuchild href="/netbank/information.jsp"
							target=main>查看信息</a>
						</td>
					</tr>
					<tr height=20>
						...
						<td><a class=menuchild href="/netbank/modify.jsp" target=main>修改个人信息</a>
						</td>
					</tr>
					<tr height=20>
						<td align=middle width=30><img height=9
						...
						<td><a class=menuchild href="/netbank/changepwd.jsp"
							target=main>修改密码</a>
						</td>
					</tr>
					<tr height=20>
