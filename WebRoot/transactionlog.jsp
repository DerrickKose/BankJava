	...
	<div align="center">
		<table width="650"
			...
			<thead>
				...
				<tr>
					<td colspan="5"
						style="font-size:18px;font-weight:bold; text-align:center;">交易记录</td>
				</tr>
				<tr style="font-weight:bold;">
					<td style="width:117px;">&nbsp;序号</td>
					<td style="width:117px;">&nbsp;对方账户</td>
					<td style="width:117px;">&nbsp;交易金额</td>
					<td style="width:117px;">&nbsp;交类类型</td>
					<td style="width:117px;">&nbsp;交易日期</td>
				</tr>
			</thead>
			<tbody align="center">
				<!--循环显示记录部分  -->
				<s:iterator value="#request.logs" status="status">
					<tr>
						...
						<s:if
							test="otherid==#session.user.accountid&&transactionType.name!='取款'">
		...
		<table>
			<tr>
				...
				<A
							href='/netbank/transaction/list?pager.curPage=${pager.curPage-1 }'>上一页</A>
					</s:if>
				</td>
				<td width="80"><s:if test="pager.curPage < pager.pageCount">
						<A
							href='/netbank/transaction/list?pager.curPage=${pager.curPage+1}'>下一页</A>&nbsp;&nbsp;
				<A
							href='/netbank/transaction/list?pager.curPage=${pager.pageCount }'>尾页</A>
					</s:if>
				</td>
				<td>共${pager.curPage}/${pager.pageCount}页&nbsp;&nbsp; 转至 <select
